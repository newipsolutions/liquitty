...
import { Card, CardBody, CardText, Col, Container, Row, CardHeader, CardGroup , CardColumns ,CardImg, CardTitle} from "reactstrap";
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Cards | Dashonic - React Admin & Dashboard Template</title>
        </MetaTags>
        <Container fluid>
          {/* Render Breadcrumbs */}
          ...
          <Row>
            <div className="col-12">
              <div className="justify-content-between d-flex align-items-center mt-3 mb-4">
                ...
                <Link to="//reactstrap.github.io/components/card/" target="_blank" rel="noreferrer" className="btn btn-sm btn-soft-secondary">Docs <i className="mdi mdi-arrow-right align-middle"></i></Link>
              </div>
              <Row>
                <Col md={6}>
            ...
            <div className="col-12">
              ...
              <Row>
                <Col lg={4}>
                  <Card>
                    <CardBody>
                      <h4 className="card-title mb-1">Special title treatment</h4>
                      <CardText>
                        With supporting text below as a natural lead-in to
                        additional content.
                      </CardText>
          ...
          <Row>
            <Col xl={4}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">Nemo enim ipsam voluptatem quia voluptas site that aspernatur aut odit aut fugit sed quia consequunture magni that is dolores qui ratione voluptateme sequiit nesciunte eque porro quisquam.</p>
                  <p className="text-muted mb-0">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum.</p>
                </CardBody>
              </Card>
            </Col>
            ...
            <Col xl={4}>
              <Card>
                <div className="card-header">
                  ...
                  <p className="card-text text-muted mb-0 text-muted">Some quick example text to build on the card title and make up the bulk of the card&apos;s content.</p>
                </div>
                <CardBody>
                  <p className="text-muted mb-0">Nemo enim ipsam voluptatem quia voluptas site that aspernatur aut odit aut fugit sed quia consequunture magni that is dolores qui ratione voluptateme sequiit nesciunte eque porroquaerat that dolores eos qui voluptatem.</p>
                </CardBody>
              </Card>
            </Col>
            <Col xl={4}>
              <Card>
                <div className="card-header">
                  <h4 className="card-title mb-0"><i className="mdi mdi-emoticon-wink-outline me-1"></i> Icon In Heading</h4>
                </div>
                <CardBody>
                  <p className="text-muted mb-0">Nemo enim ipsam voluptatem quia voluptas site that aspernatur aut odit aut voluptas site that aspernatur aut odit aut fugit sed quia consequunture magni that is dolores fugit sed quia quaerat that dolores eos qui voluptatem.</p>
                </CardBody>
          ...
          <Row>
            <div className="col-12">
              <div className="justify-content-between d-flex align-items-center mt-3 mb-4">
                <h5 className="mb-0 pb-1 text-decoration-underline">Card Image Caps & Overlays</h5>
                <Link to="//reactstrap.github.io/components/card/" target="_blank" rel="noreferrer" className="btn btn-sm btn-soft-secondary">Docs <i className="mdi mdi-arrow-right align-middle"></i></Link>
              </div>
              <Row>
                ...
                <Col lg={6}>
                  <Card>
                    <Row className="no-gutters align-items-center">
                      <Col md={4}>
                        <img className="card-img img-fluid" src={img2} alt="Card image" />
                      </Col>
                      <Col md={8}>
                        <CardBody>
                          <h5 className="card-title mb-1">Card title</h5>
                          <CardText className="card-text">This is a wider card with supporting text below as a natural lead-in to additional content.</CardText>
                          <CardText className="card-text"><small className="text-muted">Last updated 3 mins ago</small></CardText>
                        </CardBody>
                      </Col>
                    </Row>
                  </Card>
                ...
                <Col lg={6}>
                  <Card>
                    <Row className="no-gutters align-items-center">
                      ...
                      <Col md={4}>
                        <img className="card-img img-fluid" src={img3} alt="Card image" />
                      </Col>
                    </Row>
                  </Card>
                </Col>
              ...
              <Row>
                <Col lg={4}>
                  <Card className="bg-primary text-white-50">
                    <CardHeader className="h6 bg-primary text-white">Primary Card</CardHeader>
                    <CardBody>
                ...
                <Col lg={4}>
                  <Card className="bg-success text-white-50">
                    <CardHeader className="h6 bg-success text-white">Success Card</CardHeader>
                    <CardBody>
                      <CardText>Some quick example text to build on the card title and make up the bulk of the card&apos;s content.</CardText>
                    </CardBody>
                  </Card>
                ...
                <Col lg={4}>
                  <Card className="bg-info text-white-50">
                    <CardHeader className="h6 bg-info text-white">Info Card</CardHeader>
                    <CardBody>
                      <CardText>Some quick example text to build on the card title and make up the bulk of the card&apos;s content.</CardText>
                    </CardBody>
                  </Card>
          ...
          <Row>
            <Col lg={4}>
              <Card className="bg-warning text-white-50">
                <h6 className="card-header bg-warning text-white">Warning Card</h6>
                <CardBody>
                  <CardText>Some quick example text to build on the card title and make up the bulk of the card&apos;s content.</CardText>
                </CardBody>
              </Card>
            ...
            <Col lg={4}>
              <Card className="bg-danger text-white-50">
                <h6 className="card-header bg-danger text-white">Danger Card</h6>
                <CardBody>
                  <CardText>Some quick example text to build on the card title and make up the bulk of the card&apos;s content.</CardText>
                </CardBody>
              </Card>
          ...
          <Row>
            <Col lg={4}>
              <Card className="bg-secondary text-white-50">
                <h6 className="card-header bg-secondary text-white">Secondary Card</h6>
                <CardBody>
                  <CardText>Some quick example text to build on the card title and make up the bulk of the card&apos;s content.</CardText>
                </CardBody>
              </Card>
            ...
            <Col lg={4}>
              <Card className="bg-purple text-white-50">
                <h6 className="card-header bg-purple text-white">Purple Card</h6>
                <CardBody>
                  <CardText>Some quick example text to build on the card title and make up the bulk of the card&apos;s content.</CardText>
                </CardBody>
              </Card>
                ...
                <Col lg={4}>
                  <Card className="border border-primary">
                    <CardHeader className="bg-transparent border-primary">
                      <h6 className="my-0 text-primary">Primary Outline Card</h6>
                    </CardHeader>
                    <CardBody>
                      <h5 className="card-title mb-1">card title</h5>
                      <CardText>Some quick example text to build on the card title and make up the bulk of the card&apos;s content.</CardText>
                ...
                <Col lg={4}>
                  <Card className="border border-success">
                    <CardHeader className="bg-transparent border-success">
                      <h6 className="my-0 text-success">Success Outline Card</h6>
                    </CardHeader>
                    <CardBody>
                      <h5 className="card-title mb-1">card title</h5>
                      <CardText>Some quick example text to build on the card title and make up the bulk of the card&apos;s content.</CardText>
            ...
            <Col lg={4}>
              <Card className="border border-secondary">
                <div className="card-header bg-transparent border-secondary">
                  <h6 className="my-0 text-secondary">Secondary Outline Card</h6>
                </div>
                <CardBody>
          ...
          <Row>
            <div className="col-12">
              ...
              <div className="card-deck-wrapper">
                <CardGroup>
                  <Card className="mb-4">
                    <img className="card-img-top img-fluid" src={img4} alt="Card image cap" />
                    <CardBody>
                      <h4 className="card-title mb-1">Card title</h4>
                      <CardText>This is a longer card with supporting text below as
                  ...
                  <Card className="mb-4">
                    <img className="card-img-top img-fluid" src={img5} alt="Card image cap" />
                    <CardBody>
                      <h4 className="card-title mb-1">Card title</h4>
                      <CardText>This card has supporting text below as a natural
                  ...
                  <Card className="mb-4">
                    <img className="card-img-top img-fluid" src={img6} alt="Card image cap" />
                    <CardBody>
                      <h4 className="card-title mb-1">Card title</h4>
                      <CardText>This is a wider card with supporting text below as
                        a natural lead-in to additional content.This card has even longer
                        content than the first to show that equal height action.</CardText>
                      <CardText>
                        <small className="text-muted">Last updated 3 mins ago</small>
                      </CardText>
                    </CardBody>
