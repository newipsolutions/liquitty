  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Advance Tables | Dashonic - React Admin & Dashboard Template</title>
        </MetaTags>
            ...
            <Col className="col-12">
              <Card>
                <CardHeader className="justify-content-between d-flex align-items-center">
                  ...
                  <Link to="//www.npmjs.com/package/react-super-responsive-table" target="_blank" rel="noreferrer" className="btn btn-sm btn-soft-secondary">Docs <i className="mdi mdi-arrow-right align-middle"></i></Link>
                </CardHeader>
                <CardBody>
                  <PaginationProvider
