...
import { Button, Container, Row, Card, CardBody, CardHeader } from "reactstrap";
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Sweet Alert 2 | Dashonic - React Admin & Dashboard Template</title>
        </MetaTags>
        <Container fluid={true}>
          <Breadcrumbs title="Extended UI" breadcrumbItem="Sweet Alert 2" />
          {success_dlg ? (
            <SweetAlert
              success
              title={dynamic_title}
            ...
            <div className="col-12">
              <Card>
                <CardHeader className="card-header justify-content-between d-flex align-items-center">
                  ...
                  <Link to="//www.npmjs.com/package/react-bootstrap-sweetalert" target="_blank" rel="noreferrer" className="btn btn-sm btn-soft-secondary">Docs <i className="mdi mdi-arrow-right align-middle"></i></Link>
                </CardHeader>
                <CardBody>
